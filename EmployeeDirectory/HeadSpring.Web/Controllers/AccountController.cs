...
using WebApp.Common.Infrastructure.Emailing;
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    sender.SendEmail("Please reset your password by clicking <a href=\"" + callbackUrl + "\">here</a>", string.Empty, user.UserName, "Reset Password");
                    return RedirectToAction("ForgotPasswordConfirmation", "Account");
                }

                else
                {
                    ViewBag.UserNotFound = Global.User_NotExists_Error;
                }
            }
